...
public class SortMatrixSearch {
    ...
    static int[] search (int [][]matrix, int target){
        ...
        int cols= matrix[0].length; // bew cautious matrix may be empty
        ...
        int cMid = cols/2;  // column mid *cols is length of total column
    ...
    // binary search in row or column wise
